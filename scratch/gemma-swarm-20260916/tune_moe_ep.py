...
E, TOPK, MOE_INTER, HIDDEN = 64, 8, 704, 2816   # EP2: 64 local experts, full-width expert FFN
shard_inter = 2 * MOE_INTER                 # EP: experts are not TP-sharded
DT = torch.bfloat16; BATCHES = [16,64,256,1024,2048,4096,8192,16384,1,4,512,32]
if a.merge:
    best = {}
